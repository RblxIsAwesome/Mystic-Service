      ...
      <div className="min-h-screen relative bg-black text-white overflow-x-hidden">
        ...
        <section className="relative z-10 py-24 border-t border-red-500/10">
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div
                ref={setRef("benefits-content")}
                className={cn(
                  "transition-all duration-700",
                  isVisible["benefits-content"] ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"
                )}
              >
                <span className="text-red-400 text-sm font-medium uppercase tracking-widest">Features</span>
                <h2 className="mt-4 text-4xl md:text-5xl font-bold bg-gradient-to-br from-white via-red-100 to-red-300 bg-clip-text text-transparent">
                  Everything You Need
                </h2>
                <p className="mt-4 text-neutral-400">
                  Packed with features designed to give you the best beaming experience possible.
                </p>

                <h3 className="mt-8 text-lg font-semibold text-white mb-4">Key Benefits</h3>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {benefits.map((b) => (
                    <li key={b} className="flex items-center gap-2 text-neutral-300 text-sm">
              ...
              <div
                ref={setRef("benefits-cards")}
                className={cn(
                  "grid grid-cols-2 gap-4 transition-all duration-700",
                  isVisible["benefits-cards"] ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"
                )}
              >
                <div className="p-4 rounded-xl border border-red-500/20 bg-neutral-950/50 text-center">
                ...
                <div className="p-4 rounded-xl border border-red-500/20 bg-neutral-950/50 text-center">
                  ...
                  <div className="font-semibold text-white">Growing Fast</div>
                  <div className="text-xs text-neutral-400">440+ members</div>
                </div>
                <div className="p-4 rounded-xl border border-red-500/20 bg-neutral-950/50 text-center">
                  <Zap className="h-8 w-8 text-red-400 mx-auto mb-2" />
                  <div className="font-semibold text-white">Always Online</div>
                  <div className="text-xs text-neutral-400">99% uptime</div>
                </div>
                <div className="p-4 rounded-xl border border-red-500/20 bg-neutral-950/50 text-center">
                  <Shield className="h-8 w-8 text-red-400 mx-auto mb-2" />
                  <div className="font-semibold text-white">Trusted</div>
                  <div className="text-xs text-neutral-400">Verified sites</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="relative z-10 py-24 border-t border-red-500/10">
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            >
              <span className="text-red-400 text-sm font-medium uppercase tracking-widest">Testimonials</span>
              <h2 className="mt-4 text-4xl md:text-5xl font-bold bg-gradient-to-br from-white via-red-100 to-red-300 bg-clip-text text-transparent">
                What Our Members Say
              </h2>
              <p className="mt-4 text-neutral-400">
                Join thousands of satisfied members who trust LXRPZ GEN.
              </p>
            </div>

            <div
              ref={setRef("testimonials-grid")}
              className={cn(
                "grid grid-cols-1 md:grid-cols-2 gap-6 transition-all duration-700",
                isVisible["testimonials-grid"] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              )}
            >
              {testimonials.map((t, i) => (
                <div
                  key={i}
                  className="p-6 rounded-2xl border border-red-500/20 bg-neutral-950/50 backdrop-blur-md"
                >
                  <p className="text-neutral-300 italic mb-4">&quot;{t.quote}&quot;</p>
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-full bg-red-500/20 flex items-center justify-center text-red-400 font-semibold">
                      {t.name.charAt(0)}
                    </div>
                    <div>
